...
class SavedJobsService {
  static String get _savedJobsPath {
    ...
    final paths = [
      ...
      path.join(currentDir, '..', 'backend', 'user', 'user_admin_at_admin_com', 'cv-analysis', 'saved_jobs',
          'saved_jobs.json'),
      // Path 2: Absolute path
      '/Users/mahesh/Documents/Github/cv-new/cv-magic-app/backend/user/user_admin_at_admin_com/cv-analysis/saved_jobs/saved_jobs.json',
