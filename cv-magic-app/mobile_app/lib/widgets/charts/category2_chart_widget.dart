...
/// Widget for displaying Category 2: Component Analysis as horizontal bar chart
class Category2ChartWidget extends StatelessWidget {
  final List<ChartBarData> data;
  final String totalScore;
  final String maxScore;

  const Category2ChartWidget({
    super.key,
    required this.data,
